...
export const profile: Profile = {
  ...
  intro:
    "I have 4 years of frontend experience building production web applications with React and Next.js, and hands-on backend experience - REST APIs, databases and deployment. Outside work I study natural language processing for low-resource languages: Azerbaijani and the wider Turkic family, Czech and Slovak.",
  bio: [
    "I started as a frontend intern at AzInTelecom in 2022, building the client and admin dashboards of the Sima Reporting System. From the end of 2022 to 2026 I was at Edumedia-Azerbaijan, moving from intern to middle developer on Azerbaijan's national education platforms - including a new version of Video.edu.az built with Next.js. Since 2026 I have been a full-stack developer at ITM - Information Technology Center.",
    ...
    "Professionally I am a software engineer. The research is something I do on my own time, as an enthusiast: I read papers, reproduce what I can, and I am learning to write research of my own. My direction is natural language processing for low-resource languages - Azerbaijani and the wider Turkic family, and Czech and Slovak. Adaptive learning is where I started, and EduVision and LangVis came out of it, but the weight has moved to language itself.",
    "I am preparing to take this further: a PhD in this area, and an academic track built on published work alongside the engineering one. I am not there yet - this portfolio is the record of getting there.",
