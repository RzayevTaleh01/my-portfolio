...
export const profile: Profile = {
  ...
  bio: [
    ...
    "Professionally I am a software engineer. The research is something I do on my own time, as an enthusiast: I read papers, reproduce what I can, and I am learning to write research of my own. My direction is NLP for low-resource languages - the Turkic family, such as Azerbaijani, and the West Slavic group, such as Slovak and Czech. Adaptive learning is where I started, and EduVision and LangVis came out of it, but the weight has moved to language itself.",
