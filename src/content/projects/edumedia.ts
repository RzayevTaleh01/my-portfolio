...
export const edumediaProjects: Project[] = [
  ...
  },
  {
    ...base,
    slug: "aida-mfa",
    title: "aida.mfa.gov.az",
    tagline: "The Ministry of Foreign Affairs' internal system for apostille and document legalisation, built from scratch.",
    year: 2025,
    facts: [
      { label: "Role", value: "Frontend" },
      { label: "Access", value: "Internal" },
      { label: "Domain", value: "Apostille · Legalisation" },
    ],
    overview: [
      "Beyond education, Edumedia also delivered work for the Ministry of Foreign Affairs. aida.mfa.gov.az is the ministry's internal system for apostilling and legalising documents, and it was built from scratch.",
      "It is not publicly reachable, so there is no live link.",
    ],
    stack: [{ group: "Frontend", items: ["React", "TypeScript"] }],
  },
  {
    ...base,
    slug: "mfa-gov",
    title: "Mfa.gov.az",
    tagline: "The official website of the Ministry of Foreign Affairs - support.",
    year: 2025,
    links: { demo: "https://mfa.gov.az" },
    facts: [{ label: "Role", value: "Support" }],
    overview: ["The Ministry of Foreign Affairs' official website. I worked on its support alongside the internal apostille system."],
